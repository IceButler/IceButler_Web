        ...
        info.length > 0 ? (
          info.map(item => (
            <tr key={item.userIdx}>
              ...
              <td style={tdStyle} onClick={(e) => onSendEmail(item)}><img src={email} style={imgStyle} /></td>
              <td style={tdStyle} onClick={(e) => withdrawUser(item.userIdx)}><img src={withdraw} style={imgStyle} /></td>
            </tr>
          ))
        ) : (
          <tr>
